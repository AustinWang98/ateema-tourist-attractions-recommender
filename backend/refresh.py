...
This exports pseudonymous user-level aggregates. The generated feature cache is
...
This writes three restricted CSVs into data/private/ by default. That directory
is gitignored and must stay outside public GitHub history.
"""
...
def main() -> int:
    ...
    ap.add_argument("--out", default="data/private", help="Restricted CSV output directory")
