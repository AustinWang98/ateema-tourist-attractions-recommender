...
# Optional placement boost for locations carrying the HOT SPOTS catalog flag.
# Configure it through the environment so deployments can apply their own
# transparent ranking policy without changing code.
HOT_SPOT_BOOST = float(os.getenv("HOT_SPOT_BOOST", "0.12"))
FAVORITE_BOOST = 0.03
